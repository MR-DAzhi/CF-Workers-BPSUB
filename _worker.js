    ...
    async fetch(request, env, ctx) {
        ...
        if (url.pathname === '/sub') {
            ...
            if (url.searchParams.has('sub') && url.searchParams.get('sub').trim() !== '') {
                ...
                try {
                    const subConverterResponse = await fetch(subConverterUrl, { headers: { 'User-Agent': `v2rayN/${FileName} (https://github.com/MR-DAzhi/CF-Workers-BPSUB)` } });
    ...
    try {
        ...
        const responses = await Promise.allSettled(api.map(apiUrl => fetch(apiUrl, {
            ...
            headers: {
                ...
                'User-Agent': FileName + ' (https://github.com/MR-DAzhi/CF-Workers-BPSUB)'
            },
    ...
    <div class="container">
        <div class="header">
            <div class="social-links-container">
                <a href="https://github.com/MR-DAzhi/CF-Workers-BPSUB" target="_blank" class="social-link" title="BPSUB GitHub 源码仓库">
